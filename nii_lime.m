...
isDTI = 1;
imgs.DTI = removeDotSub(imgs.DTI, isDTI); %fsl is fine with gz
imgs.DTIrev = removeDotSub(imgs.DTIrev, isDTI); %fsl is fine with gz
%end subjStructSub()

function fnm = removeDotSub (fnm,isDTI)
%topup will make 'my.img.nii.gz -> my.topup and my.img.topup.nii.gz
if nargin < 2; isDTI = 0; end;
