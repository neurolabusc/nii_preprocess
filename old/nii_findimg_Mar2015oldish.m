...
%666 doDtiPreprocessSub(dti); %preprocess images 
%666 doDtiWarpJhuSub(imgs); %warp atlas to DTI
doDtiTractSub(imgs.DTI); %compute tractography
%end doDtiSub()


function doDtiPreprocessSub(dti)
